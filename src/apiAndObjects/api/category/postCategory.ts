...
export class PostCategory extends Endpoint<CategoryDataSource, CategoryType, CategoryDataSource> {
  ...
  protected callLive(body: CategoryType): Promise<CategoryDataSource> {
    ...
    const callResponsePromise = this.apiCaller.doCall(['category'], RequestMethod.POST, undefined, body, headers);
