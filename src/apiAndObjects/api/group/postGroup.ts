...
export class PostGroup extends CacheableEndpoint<GroupsDataSource, Group, GroupsDataSource> {
  ...
  protected callLive(body: Group): Promise<GroupsDataSource> {
    ...
    const callResponsePromise = this.apiCaller.doCall(['group'], RequestMethod.POST, undefined, body, headers);
