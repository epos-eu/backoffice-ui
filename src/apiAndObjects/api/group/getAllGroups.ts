...
export class GetAllGroups extends CacheableEndpoint<Array<GroupsDataSource>, GetAllGroupsParams, GroupsDataSource> {
  ...
  protected callLive(): Promise<GroupsDataSource[]> {
