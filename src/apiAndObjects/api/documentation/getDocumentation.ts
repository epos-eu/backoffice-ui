...
export class GetDocumentation extends Endpoint<Array<DocumentationType>, GetDocumentationParams, DocumentationType> {
  ...
  protected callLive(params: GetDocumentationParams): Promise<DocumentationType[]> {
    ...
    const callResponsePromise = this.apiCaller
      .doCall(`documentation/${params.metaId}/${params.instanceId}`, RequestMethod.GET, undefined, undefined, headers)
  ...
  private processResponseData(data: Array<Record<string, unknown>> | unknown, params: GetDocumentationParams) {
