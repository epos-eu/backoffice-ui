...
export class PostCategoryScheme extends Endpoint<
...
> {
  ...
  protected callLive(body: CategorySchemeType): Promise<CategorySchemeDataSource> {
    ...
    const callResponsePromise = this.apiCaller.doCall(['categoryscheme'], RequestMethod.POST, undefined, body, headers);
