...
export class PostMapping extends CacheableEndpoint<Mapping, Mapping, Mapping> {
  private persistorService: PersistorService = new PersistorService();

  protected getCacheKey(params: PostMappingParams): string {
  ...
  protected callLive(body: Mapping): Promise<Mapping> {
    ...
    const callResponsePromise = this.apiCaller.doCall(['mapping'], RequestMethod.POST, undefined, body, headers);
...
export interface PostMappingParams {}
